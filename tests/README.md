...
plan and log format). The suite runs end-to-end on this machine: **3018 passed / 0 failed /
0 skipped** (2026-09-13, ~37 s) — `node tests/runner.js` from the workspace root.
