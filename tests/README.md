...
plan and log format). The suite runs end-to-end on this machine: **3259 passed / 0 failed /
0 skipped** (2026-09-14, ~38 s) — `node tests/runner.js` from the workspace root.
