...
plan and log format). The suite runs end-to-end on this machine: **3136 passed / 0 failed /
0 skipped** (2026-09-14, ~41 s) — `node tests/runner.js` from the workspace root.
