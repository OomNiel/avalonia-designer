...
plan and log format). The suite runs end-to-end on this machine: **3721 passed / 0 failed /
0 skipped** (2026-09-15, ~53 s) — `node tests/runner.js` from the workspace root.
