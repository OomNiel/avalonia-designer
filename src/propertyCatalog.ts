...
export const CONTROL_PROPS: Record<string, PropTemplate[]> = {
    ...
    GrumpySheet: [
        // Dockable like any panel child, and it matters more here than for most controls: a sheet is
        // usually ONE region of a form — a grid docked Bottom under a body, or docked Left beside it —
        // rather than a thing placed at an exact spot. Choosing a real dock makes the designer wrap the
