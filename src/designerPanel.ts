...
${publishButtons}      <span class="sep"></span>
      ...
      <div class="modal-box modal-sheet">
        ...
        <div class="sheet-format">
          ...
          <label class="sheet-tool-field sheet-color" title="The selection's text colour — the × puts it back on the sheet's own">Text
            <button id="sheetTextColor" type="button" class="sheet-well" title="Choose the text colour from the palette"></button><button id="sheetTextColorNone" type="button" class="sheet-none" title="Use the sheet's own text colour">&times;</button></label>
          <label class="sheet-tool-field sheet-color" title="The selection's highlight — the × takes it away">Fill
            <button id="sheetFill" type="button" class="sheet-well" title="Choose the highlight colour from the palette"></button><button id="sheetFillNone" type="button" class="sheet-none" title="No highlight — the sheet's own paper colour">&times;</button></label>
    ...
    <div id="axisModal" class="modal" hidden>      <div class="modal-box modal-wide">
        ...
        <p class="modal-hint">The <b>common</b> X and Y axes are what every series uses by default.
          ...
          and delete it again to leave that axis to the common one.</p>
        <div class="grid-defs">
          <div class="grid-defs-col">
            <h4>Axes</h4>
            <div id="axisList" class="grid-def-list"></div>
            <div class="series-buttons">
              <button id="axisAdd" type="button" class="modal-btn">Add axis</button>
              <button id="axisDel" type="button" class="modal-btn warning">Delete</button>
            </div>
          </div>
          <div class="grid-defs-col">
            <h4 id="axisHead">Axis</h4>
            <div id="axisFields" class="series-fields"></div>
          </div>
        </div>
        <div class="modal-buttons">
          <button id="axisCancel" type="button" class="modal-btn">Cancel</button>
          <button id="axisSave" type="button" class="modal-btn primary">Save</button>
        </div>
      </div>
    </div>
    ...
    <div id="dotGridModal" class="modal" hidden>
      <div class="modal-box modal-narrow">
        ...
        <div class="grid-settings">
          ...
          <label>Color <button id="dotGridColor" type="button" class="color-swatch" title="Choose the dot colour from the palette"></button></label>
    ...
    <div id="crosshairModal" class="modal" hidden>
      <div class="modal-box modal-narrow">
        ...
        <div class="grid-settings">
          ...
          <label>Colour <button id="chColor" type="button" class="color-swatch" title="Choose the crosshair colour from the palette"></button></label>
        </div>
        <div class="modal-buttons">
