...
function writeStage(plan: PublishPlan): void {
    ...
    for (const file of debTree({
        ...
        longDescription: [
            plan.description,
            `Built from ${path.basename(plan.projectFile)} with Grumpy's WYSIWYG Designer for VS Code.`,
...
export function windowsPublishScript(plan: PublishPlan): string {
    ...
    return `# Generated by Grumpy's WYSIWYG Designer — Publish (Windows). Re-runnable by hand.
...
# Generated by Grumpy's WYSIWYG Designer — Publish. Re-runnable by hand.
set -euo pipefail
